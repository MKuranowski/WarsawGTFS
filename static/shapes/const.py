...
OVERRIDE_SHAPE_RATIOS: Mapping[Tuple[str, str], float] = {
    ...
    ("302503", "302501"):  8.7, ("318501", "318502"): 15.6, ("325402", "325401"): 24.0,
...
PATH_BETWEEN_STOPS_VIA: Mapping[Tuple[str, str], Tuple[float, float]] = {
    ("156101", "128701"): (52.3242592, 21.0483360),  # 132 for Metro Marymont
    ...
    ("318501", "318502"): (52.0900580, 21.1219674),  # 251 for Konstancin-J.
    ("423601", "413801"): (52.1732054, 20.8394632),  # 717 for Dw. Zachodni
